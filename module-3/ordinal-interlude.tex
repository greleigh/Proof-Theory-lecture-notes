...
\begin{definition}[Addition on ordinals]
...
%	As \( α = \sup \setof{ ξ + ξ }[ξ < α ] \) the claim is established.
...
First, I need
%The next \namecref{ord-AP-normal} shows that the function enumerating the additive principal ordinals is defined on all ordinals, is order preserving and continuous.
...
\begin{definition}[Enumeration of the additive principal ordinals]
	\( ω^α ≔ E_\AP(α) \).
\end{definition}
...
\begin{definition}[Additive normal form]
...
\begin{definition}[Cantor normal form]
